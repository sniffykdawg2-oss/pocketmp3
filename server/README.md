...
8. Deploy.
9. Copy the service URL, for example:

   ```text
   https://pocketmp3-converter.onrender.com
   ```

10. In GitHub, go to **Settings** -> **Secrets and variables** -> **Actions** -> **Variables**.
11. Add a repository variable:

   ```text
   VITE_CONVERTER_API_URL=https://YOUR-RENDER-SERVICE.onrender.com
   ```

12. Re-run the **Deploy GitHub Pages** workflow.
